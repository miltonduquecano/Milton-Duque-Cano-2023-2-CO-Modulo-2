...
from dino_runner.utils.constants import DUCKING, RUNNING, JUMPING, DUCKING_SHIELD, RUNNING_SHIELD, JUMPING_SHIELD, DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, RUNNING_HAMMER, DUCKING_HAMMER, JUMPING_HAMMER
