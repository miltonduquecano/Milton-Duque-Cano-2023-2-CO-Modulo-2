...
from dino_runner.utils.constants import DUCKING, RUNNING, JUMPING, DUCKING_SHIELD, RUNNING_SHIELD, JUMPING_SHIELD

RUN_IMAGE = {'DEFAULT_TYPE': RUNNING, 'SHIELD_TYPE': RUNNING_SHIELD}
DUCK_IMAGE = {'DEFAULT_TYPE': DUCKING, 'SHIELD_TYPE': RUNNING_SHIELD}
